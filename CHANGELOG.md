...
- Workspaces with the same folder name now show their parent paths in the workspace switcher, making them easier to distinguish. [#181](https://github.com/bholmesdev/hubble.md/pull/181)
